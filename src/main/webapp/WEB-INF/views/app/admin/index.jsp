              ...
              <div class="card info-card revenue-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li value="0"><a class="dropdown-item" href="#">Today</a></li>
                    <li value="1"><a class="dropdown-item" href="#">This Month</a></li>
                    <li value="2"><a class="dropdown-item" href="#">This Year</a></li>
                  </ul>
                </div>
